...
def run_python_script(int1, int2)
  # Convert Ruby list to a string for passing as a command-line argument
  input_list_str = $dice_files.join(',')
  $dice_files = []

  # Run the Python script asynchronously
 # command = "python3 /home/evans/Documents/Discord/DiceMaiden/diceImageMaker.py #{input_list_str} #{int1} #{int2}"
...
def process_roll_token(_event, token)
 ...
 # print(parse_roll)
  ...
  $dice_files.append("/home/evans/Documents/Discord/DiceMaiden/DiceRolls/d#{parse_roll[0][1].value[:sides]}/#{@tally[1..-2]}.png")
  
#  image_path = "/home/evans/Documents/Discord/DiceMaiden/DiceRolls/d#{parse_roll[0][1].value[:sides]}/#{@tally[1..-2]}.png"
#  _event.channel.send_file(File.open(image_path, 'r'))
